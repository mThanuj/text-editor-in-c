 ...
 *
 */
void render_screen(const EditorState* s) {
  // Clear the screen
  clear();
  ...
  int screen_row = s->row - s->scroll_offset_row;
  int screen_col = s->col - s->scroll_offset_col + LINE_NUMBER_WIDTH;
